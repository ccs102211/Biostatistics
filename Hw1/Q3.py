...
# (a)
literacy_rates = pd.read_csv(
    "C:\\Users\\chien\\Desktop\\Biostatistics\\Hw1\\literacy_rates.csv")
...
# (b)
print("Outliers of Female = ", find_outliers(
    np.array(literacy_rates['female'])))
